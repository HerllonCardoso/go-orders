...
// resource from the testify package to initialize everything that we need for testing purposes
type OrderRepositoryTestSuite struct {
	suite.Suite
	Db *sql.DB
}

// setup the suite creating a sqlite instance in memory for testing
